...
public class Dinosaur : MonoBehaviour
{
    ...
    [Header("Health")]
    [SerializeField] protected int maxHealth              = 3; // Passé en protected pour le Mega !
    ...
    public void SetParent(Dinosaur parent) => _parent = parent;
    public void AddChild(Dinosaur child) => _children.Add(child);
